  ...
  return (
    <div className="login-shell">
      <section className="login-hero">
        ...
        <p>
          Mỗi tài khoản được cung cấp đúng không gian làm việc theo
          nhiệm vụ: quản trị, xét duyệt hoặc nộp hồ sơ.
        </p>
      </section>
      ...
      <section className="login-panel">
        <div className="card login-card">
          ...
          <p>
            Sinh viên nhập MSSV; Chi đoàn hoặc Câu lạc bộ nhập mã
            đơn vị. Hệ thống tự bổ sung @dntu.edu.vn.
          </p>
