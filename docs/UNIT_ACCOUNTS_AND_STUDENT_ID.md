...
- Sau khi đăng nhập bằng `123456`, hệ thống chỉ cho mở `/change-password`.
- Mật khẩu mới phải có ít nhất 10 ký tự, gồm chữ và số.
- Quản trị viên có thể đặt lại tài khoản đơn vị về `123456` tại trang quản lý Chi đoàn/CLB.
- Khi Chi đoàn hoặc CLB ngừng sử dụng, tài khoản đại diện cũng bị khóa.

## Chính sách mật khẩu của dự án

Mật khẩu khởi tạo của tài khoản Chi đoàn/CLB là `123456`. Vì vậy cấu hình xác thực của dự án phải cho phép mật khẩu tối thiểu 6 ký tự. Hệ thống vẫn bảo vệ bằng cách bắt buộc đổi sang mật khẩu tối thiểu 10 ký tự, có chữ và số ngay sau lần đăng nhập đầu tiên.
